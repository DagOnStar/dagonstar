...
def summarize_fog_data(edge_csv_paths, day, month, output_path):
    day_str = f"{day:02d}"
    d_col = f"D{day_str}"
    v_col = f"V{day_str}"
    all_data = []
    print(edge_csv_paths)
...
if __name__ == "__main__":
    ...
    summary = summarize_fog_data(args.edge_csv_path, args.day, args.month, args.output_path)
